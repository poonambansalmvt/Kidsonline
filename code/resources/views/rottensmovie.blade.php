								...
								<div class="jp-type-list-parent">
									<div class="jp-type-single">
										<div id="jquery_jplayer_2245" class="jp-jplayer" style="width: 100%; height: 100%;">
											<img id="jp_poster_0" src="<?php if($data[0]->poster_image == 'N/A'){ echo "http://kidsonline.devserver.co.in/assets/images/default-slide-img.jpg"; }else{ 
												$image = $data[0]->poster_image;;
										...
										<div class="jp-gui">
											<div class="jp-video-play" style="display: block;">
												<a href="<?php echo $data[0]->url; ?>" class="jp-video-play-icon" tabindex="1" title="Play" target="_blank">Play</a>
											</div>
							...
							<div class="post_meta meta_type_line">
								...
								<div class="post_meta_unite clearfix"> 
									<div class="post_comment">
										Genre: 
										<span style="color:#58cb7e;"><?php echo $data[0]->other_values; ?></span>
									</div>
												...
												<div id="categories-4" class="widget">
													...
													<ul>
														<li class="cat-item cat-item-2">
															<a href="" title="View all posts filed under Aenean nec eros estibulum ante ipsum"><?php echo $data[0]->other_values;?></a>
														</li>
