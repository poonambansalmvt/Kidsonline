		...
		<div class="row">
			<div class="col-md-12 padding_nill">
				<section class="title-section">
					...
					<li class="divider"></li>
					<li class="active">Rotten-Tomatoes</li></ul>  
				</section>
			</div>
				...
				<div class="col-md-4 padding_left">
					<div class="portfolio_item_holder">
						<figure class="thumbnail thumbnail__portfolio">
							<a href="{{ url('/rottensmovie')}}/<?php echo $value->id; ?>" class="image-wrap" title="Image Format" rel="prettyPhoto">
							<img style="height:212px;" src="<?php if($value->poster_image != 'N/A' && $value->poster_image != 'None'){
								$image = $value->poster_image;
						...
						<h3><a href="{{ url('/rottensmovie')}}/<?php echo $value->id; ?>"><?php $title = $value->title; echo $string = substr($title,0,20).'...'; ?></a></h3>
							<p class="excerpt"><?php 
                                    $des = $value->plot; 
