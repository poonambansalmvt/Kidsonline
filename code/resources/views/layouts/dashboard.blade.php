 ...
 <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url ('admin/dashboard') }}">Kids-Online Admin</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="<?php $_SERVER['HTTP_HOST']?>/admin/logout"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li {{ (Request::is('*charts') ? 'class="active"' : '') }}>
                            <a href="{{ url ('admin/seriesList') }}"><i class="fa fa-film"></i> Series-list</a>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-film"></i> Movies-list<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li {{ (Request::is('*blank') ? 'class="active"' : '') }}>
                                    <a href="{{ url('admin/imdbList')}}">Imdb Movies</a>
                                </li>
                                <li>
                                    <a href="{{ url('admin/rottenList')}}">Rotten-Tomatoes Movies</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-picture-o"></i> Slider Images<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li {{ (Request::is('*blank') ? 'class="active"' : '') }}>
                                    <a href="{{ url('admin/addsliderimg')}}">Add Slider Image</a>
                                </li>
                                <li>
                                    <a href="{{ url('admin/sliderimgList')}}">Show Slider Image</a>
                                </li>
                            </ul>
                        </li>
                        <li><a href="{{ url ('admin/settings') }}"><i class="fa fa-gear fa-fw"></i> Settings</a>
